...
class ZebraPrinter {
  ...
  ZebraPrinter(String id, this.onPrinterFound, this.onPrinterDiscoveryDone, this.onDiscoveryError, this.onChangePrinterStatus, {this.onPermissionDenied}) {
  ...
  _setSettings(Command setting, dynamic values) {
    ...
    try {
      ...
      printE("Erro em _setSettings: ${e.message}");
    }
  }
  ...
  Future<dynamic> nativeMethodCallHandler(MethodCall methodCall) async {
    if (methodCall.method == "printerFound") {
      onPrinterFound!(methodCall.arguments["Name"], methodCall.arguments["Address"], methodCall.arguments["IsWifi"].toString() == "true" ? true : false);
    } else if (methodCall.method == "changePrinterStatus") {
      onChangePrinterStatus!(methodCall.arguments["Status"], methodCall.arguments["Color"]);
